...
store.subscribe(() => {
  ...
  console.log('EXP: ', state.filters)
  const visibleExpenses = getVisibleExpenses(state.expenses, state.filters);
  console.log('STORE_SUBSCR:', visibleExpenses);
})
// EXPENSE DISPATCHES
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 100, createdAt: 1000}));
const expenseTwo = store.dispatch(addExpense({ description: 'Coffee', amount: 400, createdAt: -1}));
...
// store.dispatch(sortByDate());
 ...
 store.dispatch(setEndDate(1000));  //undefined
